...
NetApp AFX 針對高效能 NAS 和物件工作負載進行了最佳化。因此，它與AFF和FAS以及其他統一ONTAP儲存系統存在差異。以下功能在NetApp AFX 中不可用；此清單按主要功能或功能領域進行組織。您還應該查看 AFX 的更新和變更。link:../release-notes/whats-new-9171.html["什麼是新的"]根據你的版本。
