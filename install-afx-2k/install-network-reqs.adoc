...
[role="lead"]
記錄連接到 AFX 2K 儲存系統的每個網路所需的資訊。



== 收集網路資訊

在開始安裝 AFX 2K 儲存系統之前，請收集所需的網路資訊
...
對於 Cisco Nexus 9808、Cisco Nexus 9332D-GX2 和 9364D-GX2A 交換器的安裝和維護，請務必查看佈線和網路需求。
...
.下一步是什麼？
在審查了網路需求之後，您link:cable-hardware.html["為您的 AFX 2K 儲存系統連接控制器和儲存架"]。
