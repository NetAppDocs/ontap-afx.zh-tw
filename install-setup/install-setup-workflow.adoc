...
NOTE: 如果您要部署具有 AI Data Engine （AIDE） 的 AFX 1K，請在啟動 AFX 系統後安裝 AIDE 資料計算節點。如需更多資訊，請參閱 link:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["安裝 AIDE 資料計算節點"]。
