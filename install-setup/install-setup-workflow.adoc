...
[NOTE]
====
如果您要部署具有 AI Data Engine（AIDE）的 AFX 1K，則可以在完成 AFX 系統的安裝後安裝 AIDE 資料運算節點。

* 對於第三方伺服器部署，請參閱 https://docs.netapp.com/us-en/ai-data-engine/install-aide-server/aide-mde-server-hardware-requirements.html["在第三方伺服器上搭載 AIDE 軟體的 AI Data Engine 需求"^]和 https://docs.netapp.com/us-en/ai-data-engine/install-setup/install-aide-as-software.html["在第三方伺服器上安裝 AIDE 軟體"^]。
* 有關 NetApp DCN 部署，請參閱 https://docs.netapp.com/us-en/ai-data-engine/install-dcn/aide-dcn-hardware-requirements.html["AI Data Engine 對 NetApp 所提供的資料運算節點的需求"^]。
