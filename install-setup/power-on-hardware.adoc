...
.下一步是什麼？
啟動 AFX 1K 儲存系統後，根據您的部署選項完成設定：

* 對於專用 AFX 1K 儲存系統部署，請前往link:../install-setup/cluster-setup.html["設定 AFX 叢集"]。
* 對於搭載 AI Data Engine（AIDE）的 AFX 1K 部署，請安裝 AIDE 第三方伺服器或 NetApp 提供的資料運算節點：
